...
unset($__errorArgs, $__bag); ?>" name="username" value="<?php echo e(old('username')); ?>" id="input-username" placeholder="Enter Username" required>
...
unset($__errorArgs, $__bag); ?>" name="name" value="<?php echo e(old('name')); ?>" id="input-name" placeholder="Enter Full Name" required>
...
unset($__errorArgs, $__bag); ?>" name="avatar"  id="input-avatar" accept="image/*">
...
<?php echo $__env->make('layouts.master-without-nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\swjp\resources\views/auth/register.blade.php ENDPATH**/ ?>