...
<html class="no-js" lang="en-US">
	...
	<head>
		...
		<!-- Bootstrap -->
		<link rel="stylesheet" href="<?php echo e(asset('frontend/library/bootstrap/css/bootstrap.min.css')); ?>">

		<!-- Font awesome -->
		<link rel="stylesheet" href="<?php echo e(asset('frontend/library/fontawesome/css/all.min.css')); ?>">

		<!-- Linea icons -->
		<link rel="stylesheet" href="<?php echo e(asset('frontend/library/linea/arrows/styles.css')); ?>" />
		<link rel="stylesheet" href="<?php echo e(asset('frontend/library/linea/basic/styles.css')); ?>" />
		<link rel="stylesheet" href="<?php echo e(asset('frontend/library/linea/ecommerce/styles.css')); ?>" />
        <link rel="stylesheet" href="<?php echo e(asset('frontend/library/linea/software/styles.css')); ?>" />
        <link rel="stylesheet" href="<?php echo e(asset('frontend/library/linea/weather/styles.css')); ?>" />

		<!-- Animate -->
		<link rel="stylesheet" href="<?php echo e(asset('frontend/library/animate/animate.css')); ?>">

		<!-- Lightcase -->
		<link rel="stylesheet" href="<?php echo e(asset('frontend/library/lightcase/css/lightcase.css')); ?>">

		<!-- Swiper -->
		<link rel="stylesheet" href="<?php echo e(asset('frontend/library/swiper/swiper-bundle.min.css')); ?>">

		<!-- Owl carousel -->
		<link rel="stylesheet" href="<?php echo e(asset('frontend/library/owlcarousel/owl.carousel.min.css')); ?>">

		<!-- Slick carousel -->
		<link rel="stylesheet" href="<?php echo e(asset('frontend/library/slick/slick.css')); ?>">

		<!-- Magnific popup -->
		<link rel="stylesheet" href="<?php echo e(asset('frontend/library/magnificpopup/magnific-popup.css')); ?>">

		<!-- YTPlayer -->
		<link rel="stylesheet" href="<?php echo e(asset('frontend/library/ytplayer/css/jquery.mb.ytplayer.min.css')); ?>">

		<!-- Stylesheet -->
		<link rel="stylesheet" href="<?php echo e(asset('frontend/css/style.css')); ?>">
		<link rel="stylesheet" href="<?php echo e(asset('frontend/css/media.css')); ?>">

		<!-- Color schema -->
		<link rel="stylesheet" href="<?php echo e(asset('frontend/colors/blue.css')); ?>" class="colors">
	...
	<body>
				...
				<div class="row align-items-center">
					...
					<div class="col-12 col-lg-6">
						...
						<div class="banner-image wow fadeInUp" data-wow-offset="10" data-wow-duration="1s" data-wow-delay="0.3s">
							<img class="bounce-effect" src="<?php echo e(asset('frontend/images/mainImage.png')); ?>" alt="" />
						</div>
			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="clients-slider owl-carousel owl-theme">
						...
						<!-- Client 1 -->
						<div class="client">
							<a href="#"><img src="<?php echo e(asset('frontend/images/clients/citii.png')); ?>" alt="Client 1"></a>
						</div>

						<!-- Client 2 -->
						<div class="client">
							<a href="#"><img src="<?php echo e(asset('frontend/images/clients/garuda.png')); ?>"  alt="Client 2"></a>
						</div>

						<!-- Client 3 -->
						<div class="client">
							<a href="#"><img src="<?php echo e(asset('frontend/images/clients/indomal.png')); ?>"  alt="Client 3"></a>
						</div>

						<!-- Client 4 -->
						<div class="client">
							<a href="#"><img src="<?php echo e(asset('frontend/images/clients/lion.png')); ?>"  alt="Client 4"></a>
						</div>

						<!-- Client 5 -->
						<div class="client">
							<a href="#"><img src="<?php echo e(asset('frontend/images/clients/sriwijaya.png')); ?>"  alt="Client 5"></a>
						</div>

						<!-- Client 6 -->
						<div class="client">
							<a href="#"><img src="<?php echo e(asset('frontend/images/clients/airasia.png')); ?>"  alt="Client 6"></a>
						</div>

						<!-- Client 7 -->
						<div class="client">
							<a href="#"><img src="<?php echo e(asset('frontend/images/clients/batik.png')); ?>"  alt="Client 7"></a>
						</div>

						<!-- Client 8 -->
						<div class="client">
							<a href="#"><img src="<?php echo e(asset('frontend/images/clients/damri.png')); ?>"  alt="Client 8"></a>
						</div>
					...
					<div class="col-12 testimonial-carousel">
						...
						<div class="block-media row">
							<div class="carousel-images testimonial-nav col-12 col-lg-8 offset-lg-2">
								...
								<div>
									<img src="<?php echo e(asset('frontend/images/testimonials/client-1.jpg')); ?>" alt="" class="img-fluid rounded-circle">
								...
								<div>
									<img src="<?php echo e(asset('frontend/images/testimonials/client-2.jpg')); ?>" alt="" class="img-fluid rounded-circle">
									<div class="client-info">
										<h3>Martin Jack</h3>
								...
								<div>
									<img src="<?php echo e(asset('frontend/images/testimonials/client-3.jpg')); ?>" alt="" class="img-fluid rounded-circle">
									<div class="client-info">
										<h3>David Dowsy</h3>
										<span>From Acme</span>
									</div>
								...
								<div>
									<img src="<?php echo e(asset('frontend/images/testimonials/client-4.jpg')); ?>" alt="" class="img-fluid rounded-circle">
									<div class="client-info">
										<h3>Doglas Kosta</h3>
								...
								<div>
									<img src="<?php echo e(asset('frontend/images/testimonials/client-5.jpg')); ?>" alt="" class="img-fluid rounded-circle">
									<div class="client-info">
										<h3>Anthony Lee</h3>
								...
								<div>
									<img src="<?php echo e(asset('frontend/images/testimonials/client-6.jpg')); ?>" alt="" class="img-fluid rounded-circle">
									<div class="client-info">
										<h3>Jonathon Doe</h3>
								...
								<div>
									<img src="<?php echo e(asset('frontend/images/testimonials/client-7.jpg')); ?>" alt="" class="img-fluid rounded-circle">
									<div class="client-info">
										<h3>Xenia Mell</h3>
								...
								<div>
									<img src="<?php echo e(asset('frontend/images/testimonials/client-8.jpg')); ?>" alt="" class="img-fluid rounded-circle">
									<div class="client-info">
										<h3>Shane Catson</h3>
								...
								<div>
									<img src="<?php echo e(asset('frontend/images/testimonials/client-9.jpg')); ?>" alt="3" class="img-fluid rounded-circle">
									<div class="client-info">
										<h3>Chris Wort</h3>
			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-12 col-md-6 col-lg-3">
						<div class="team-member res-margin">
							<div class="team-image">
								<img src="<?php echo e(asset('frontend/images/team/member-1.jpg')); ?>" alt="" />
					...
					<div class="col-12 col-md-6 col-lg-3">
						<div class="team-member res-margin">
							<div class="team-image">
								<img src="<?php echo e(asset('frontend/images/team/member-2.jpg')); ?>" alt="" />
								<div class="team-social">
									<div class="team-social-inner">
										<a href="#"><i class="fab fa-twitter"></i></a>
										<a href="#"><i class="fab fa-facebook-f"></i></a>
					...
					<div class="col-12 col-md-6 col-lg-3">
						<div class="team-member res-margin">
							<div class="team-image">
								<img src="<?php echo e(asset('frontend/images/team/member-3.jpg')); ?>" alt="" />
								<div class="team-social">
									<div class="team-social-inner">
										<a href="#"><i class="fab fa-twitter"></i></a>
										<a href="#"><i class="fab fa-facebook-f"></i></a>
					...
					<div class="col-12 col-md-6 col-lg-3">
						<div class="team-member">
							<div class="team-image">
								<img src="<?php echo e(asset('frontend/images/team/member-4.jpg')); ?>" alt="" />
								<div class="team-social">
									<div class="team-social-inner">
										<a href="#"><i class="fab fa-twitter"></i></a>
										<a href="#"><i class="fab fa-facebook-f"></i></a>
				...
				<div class="row">
					...
					<div class="col-12">
						...
						<div class="owl-carousel owl-theme screenshot-slider zoom-screenshot">
							...
							<div class="item">
								<a href="<?php echo e(asset('frontend/images/destinasi/bali.png')); ?>">
									<img src="<?php echo e(asset('frontend/images/destinasi/bali.png')); ?>" alt="" />
								</a>
							</div>

							<div class="item">
								<a href="<?php echo e(asset('frontend/images/destinasi/monas.png')); ?>">
									<img src="<?php echo e(asset('frontend/images/destinasi/monas.png')); ?>" alt="" />
								</a>
							</div>

							<div class="item">
								<a href="<?php echo e(asset('frontend/images/destinasi/sumbar.png')); ?>">
									<img src="<?php echo e(asset('frontend/images/destinasi/sumbar.png')); ?>" alt="" />
								</a>
							</div>

							<div class="item">
								<a href="<?php echo e(asset('frontend/images/destinasi/surabaya.png')); ?>">
									<img src="<?php echo e(asset('frontend/images/destinasi/surabaya.png')); ?>" alt="" />
								</a>
							</div>

							<div class="item">
								<a href="<?php echo e(asset('frontend/images/destinasi/danautoba.png')); ?>">
									<img src="<?php echo e(asset('frontend/images/destinasi/danautoba.png')); ?>" alt="" />
								</a>
							</div>

							<div class="item">
								<a href="<?php echo e(asset('frontend/images/destinasi/perambanan.png')); ?>">
									<img src="<?php echo e(asset('frontend/images/destinasi/perambanan.png')); ?>" alt="" />
								</a>
							</div>

							<div class="item">
								<a href="<?php echo e(asset('frontend/images/destinasi/lombok.png')); ?>">
									<img src="<?php echo e(asset('frontend/images/destinasi/lombok.png')); ?>" alt="" />
								</a>
							</div>
		...
		<!-- jQuery -->
		<script src="<?php echo e(asset('frontend/library/jquery/jquery.js')); ?>"></script>
		<script src="<?php echo e(asset('frontend/library/jquery/jquery-easing.js')); ?>"></script>

		<!-- Bootstrap -->
		<script src="<?php echo e(asset('frontend/library/bootstrap/js/bootstrap.min.js')); ?>"></script>

		<!-- Plugins -->
		<script src="<?php echo e(asset('frontend/library/retina/retina.min.js')); ?>"></script>
		<script src="<?php echo e(asset('frontend/library/backstretch/jquery.backstretch.min.js')); ?>"></script>
		<script src="<?php echo e(asset('frontend/library/swiper/swiper-bundle.min.js')); ?>"></script>
		<script src="<?php echo e(asset('frontend/library/owlcarousel/owl.carousel.min.js')); ?>"></script>
		<script src="<?php echo e(asset('frontend/library/slick/slick.js')); ?>"></script>
		<script src="<?php echo e(asset('frontend/library/waypoints/jquery.waypoints.min.js')); ?>"></script>
		<script src="<?php echo e(asset('frontend/library/isotope/isotope.pkgd.min.js')); ?>"></script>
		<script src="<?php echo e(asset('frontend/library/waitforimages/jquery.waitforimages.min.js')); ?>"></script>
		<script src="<?php echo e(asset('frontend/library/lightcase/js/lightcase.js')); ?>"></script>
		<script src="<?php echo e(asset('frontend/library/wow/wow.min.js')); ?>"></script>
		<script src="<?php echo e(asset('frontend/library/parallax/jquery.parallax.min.js')); ?>"></script>
		<script src="<?php echo e(asset('frontend/library/counterup/jquery.counterup.min.js')); ?>"></script>
		<script src="<?php echo e(asset('frontend/library/magnificpopup/jquery.magnific-popup.min.js')); ?>"></script>
		<script src="<?php echo e(asset('frontend/library/ytplayer/jquery.mb.ytplayer.min.js')); ?>"></script>
...
<?php /**PATH C:\laragon\www\swjp\resources\views/frontend/index.blade.php ENDPATH**/ ?>