...
<?php $__env->startSection('title'); ?> Edit Guide <?php $__env->stopSection(); ?>
<?php $__env->startSection('content'); ?>
<?php $__env->startComponent('components.breadcrumb'); ?>
<?php $__env->slot('li_1'); ?> Data User <?php $__env->endSlot(); ?>
<?php $__env->slot('title'); ?> Edit Guide <?php $__env->endSlot(); ?>
...
<div class="row">
    <div class="col">
        <div class="card">
            <div class="card-body">
                <form method="POST" action="<?php echo e(route('user.leader.update', $user->id)); ?>" class="needs-validation" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" name="desa" id="desa"
                                    ...
                                    <option value="<?php echo e($item->id); ?>" <?php echo e(old('desa') == $item->id || $user->fasilitator->wilayah_id == $item->id ? 'selected' : ''); ?>><?php echo e($item->nama); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Project\swjp\resources\views/backend/user/guide/edit.blade.php ENDPATH**/ ?>