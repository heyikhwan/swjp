...
<?php $__env->slot('title'); ?> Edit Wilayah <?php $__env->endSlot(); ?>
...
<div class="row">
    <div class="col">
        <div class="card">
            <div class="card-body">
                <form method="POST" action="<?php echo e(route('wilayah.update', $wilayah->id)); ?>" class="needs-validation" novalidate>
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="name" name="name" placeholder="Nama Wilayah" value="<?php echo e(old('name') ?? $wilayah->nama); ?>"
                                    required>
                            </div>
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="induk" name="induk" placeholder="Induk Wilayah" value="<?php echo e(old('induk') ?? $wilayah->induk); ?>"
                                    required>
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\swjp\resources\views/backend/wilayah/edit.blade.php ENDPATH**/ ?>