...
@section('title') Tambah Paket Wisata @endsection
@section('css')
...
@slot('title') Tambah Paket Wisata @endslot
@endcomponent
...
<div class="row">
    <div class="col">
        <div class="card">
            <div class="card-body">
                <form method="POST" action="{{ route('paket-wisata.store') }}" class="needs-validation" novalidate>
                    @csrf
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('nama') is-invalid @enderror" id="nama"
                                    name="nama" placeholder="Nama Paket" value="{{ old('nama') }}" required>
                                @error('nama')
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="mb-3">
                                ...
                                <input class="form-control @error('body') is-invalid @enderror" id="body" name="body" type="text" placeholder="Masukkan Fitur" value="{{ old('body') }}" required />
                                @error('body')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
